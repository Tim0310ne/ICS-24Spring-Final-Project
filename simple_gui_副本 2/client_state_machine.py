...
#==============================================================================
            ...
            if len(my_msg) > 0:     # my stuff going out
                ...
                elif my_msg == "game_ready":
                    mysend(self.s, json.dumps({"action":"gaming", "from":"[" + self.me + "]", 'operation':'ready'}))
                elif my_msg == 'bye':
                    self.disconnect()
            ...
            if len(peer_msg) > 0:    # peer's stuff, coming in
                ...
                if peer_msg["action"] == "connect":
                    ...
                    if peer_msg['status'] == 'ready':
                        self.out_msg += 'peer is ready'
                    
                elif peer_msg['action'] == 'moving':
                    self.out_msg += '114514:'
                    self.out_msg += peer_msg['coordinate']
